-- ============================================================================
-- ARREGLAR SOLO POLÍTICAS RLS - SCRIPT SIMPLE
-- ============================================================================
-- Este script SOLO arregla las políticas RLS
-- (Realtime ya está habilitado, así que no lo tocamos)
-- ============================================================================
...
-- 5.2 Verificar que Realtime esté habilitado
SELECT 
  schemaname,
  tablename,
